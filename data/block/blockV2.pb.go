...
type HeaderV2 struct {
	Header                   *block.Header `protobuf:"bytes,1,opt,name=Header,proto3" json:"header,omitempty"`
	ScheduledRootHash        []byte        `protobuf:"bytes,2,opt,name=ScheduledRootHash,proto3" json:"scheduledRootHash,omitempty"`
	ScheduledAccumulatedFees *math_big.Int `protobuf:"bytes,3,opt,name=ScheduledAccumulatedFees,proto3,casttypewith=math/big.Int;github.com/Dharitri-org/sme-core/data.BigIntCaster" json:"scheduledAccumulatedFees,omitempty"`
	ScheduledDeveloperFees   *math_big.Int `protobuf:"bytes,4,opt,name=ScheduledDeveloperFees,proto3,casttypewith=math/big.Int;github.com/Dharitri-org/sme-core/data.BigIntCaster" json:"scheduledDeveloperFees,omitempty"`
...
func (m *HeaderV2) GetHeader() *block.Header {
	if m != nil {
		return m.Header
	}
	return nil
...
type MiniBlockReserved struct {
	ExecutionType    block.ProcessingType `protobuf:"varint,1,opt,name=ExecutionType,proto3,enum=proto.ProcessingType" json:"executionType"`
...
func (m *MiniBlockReserved) GetExecutionType() block.ProcessingType {
	if m != nil {
...
type MiniBlockHeaderReserved struct {
	ExecutionType           block.ProcessingType `protobuf:"varint,1,opt,name=ExecutionType,proto3,enum=proto.ProcessingType" json:"executionType"`
	State                   block.MiniBlockState `protobuf:"varint,2,opt,name=State,proto3,enum=proto.MiniBlockState" json:"state"`
...
func (m *MiniBlockHeaderReserved) GetExecutionType() block.ProcessingType {
	if m != nil {
		return m.ExecutionType
	}
	return block.Normal
...
func (m *MiniBlockHeaderReserved) GetState() block.MiniBlockState {
	if m != nil {
		return m.State
	}
	return block.Final
...
var fileDescriptor_17a3844aa051366e = []byte{
	...
	,
}
...
func (this *HeaderV2) String() string {
	...
	s := strings.Join([]string{`&HeaderV2{`,
		`Header:` + strings.Replace(fmt.Sprintf("%v", this.Header), "Header", "block.Header", 1) + `,`,
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExecutionType |= block.ProcessingType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= block.MiniBlockState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
