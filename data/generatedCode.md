...
```
//go:generate protoc -I=proto -I=$GOPATH/src -I=$GOPATH/src/github.com/Dharitri-org/sme-protobuf/protobuf  --gogoslick_out=. message.proto
```
...
Check [gogo protobuf geting started](https://github.com/Dharitri-org/sme-protobuf#getting-started) for initial setup.
