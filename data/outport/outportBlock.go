//go:generate protoc -I=. -I=$GOPATH/src/github.com/Dharitri-org/sme-core/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/Dharitri-org/sme-protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
